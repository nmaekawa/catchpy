...
STATIC_ROOT = os.environ.get(
    "CATCHPY_STATIC_ROOT", os.path.join(BASE_DIR, _STATIC_DIRNAME + "/")
)
...
LOGGING = {
    ...
    "loggers": {
        "anno": {"level": "DEBUG", "handlers": ["console"], "propagate": True},
        "consumer": {"level": "INFO", "handlers": ["console"], "propagate": True},
        "catchpy": {"level": "INFO", "handlers": ["console"], "propagate": True},
        "root": {
            "level": "INFO",
...
CATCH_LOG_REQUEST_TIME = (
    os.environ.get("CATCH_LOG_REQUEST_TIME", "false").lower() == "true"
)
CATCH_LOG_SEARCH_TIME = (
    os.environ.get("CATCH_LOG_SEARCH_TIME", "false").lower() == "true"
)

# log jwt and jwt error message
CATCH_LOG_JWT = os.environ.get("CATCH_LOG_JWT", "false").lower() == "true"
CATCH_LOG_JWT_ERROR = os.environ.get("CATCH_LOG_JWT_ERROR", "false").lower() == "true"
...
CORS_ALLOW_HEADERS = default_headers + ("x-annotator-auth-token",)  # for back-compat
